...
<head>
    ...
    <title>Système de gestion de bibliothèque - Error 503</title>
    <!-- Favicon icon -->
                ...
                <div class="error-content">
                    <div class="card mb-0">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i>Service indisponible</h4>
                            <p>Votre demande de service n'est pas disponible pour le moment</p>
