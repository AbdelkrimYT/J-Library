...
<head>
    ...
    <title>Système de gestion de bibliothèque - Error 400</title>
                ...
                <div class="error-content">
                    <div class="card mb-0">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i>Mauvaise demande</h4>
                            <p>La syntaxe de la requête est erronée</p>
