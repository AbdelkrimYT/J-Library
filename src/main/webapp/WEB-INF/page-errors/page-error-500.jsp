...
<head>
    ...
    <title>Système de gestion de bibliothèque - Error 500</title>
                ...
                <div class="error-content">
                    <div class="card mb-0">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i>Erreur interne du serveur</h4>
                            <p>Votre requête a généré une erreur.</p>
