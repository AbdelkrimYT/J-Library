...
<head>
    ...
    <title>Système de gestion de bibliothèque - E403</title>
                ...
                <div class="error-content">
                    <div class="card mb-0">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i>Interdit</h4>
                            <p>Refus de traitement de la requête</p>
